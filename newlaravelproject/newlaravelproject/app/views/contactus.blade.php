...
<div class="welcome">
    ...
    {{HTML::link('http://www.facebook.com/pages/Note-To-Myself/120215164719931', 'Facebook')}} |
    {{HTML::link('http://mailto:Jason_Harrison@bcit.ca', 'Email')}}
</div>
</body>
</html>
